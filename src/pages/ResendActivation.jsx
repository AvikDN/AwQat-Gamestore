        ...
        <div className="p-8 sm:p-10 flex flex-col">
          ...
          <motion.form onSubmit={handleSubmit(onSubmit)} className="space-y-6" variants={itemVariants}>
            ...
            >
              {loading ? (
                ...
                <><FaPaperPlane /> Send Activation Email</>
              )}
            </motion.button>
          </motion.form>
          ...
          >
            ...
            <ul className="text-sm text-gray-400 space-y-2 font-medium">
              <li className="flex gap-2 items-start"><span className="text-[#2ecc71]">•</span> Check your spam or junk folder</li>
              <li className="flex gap-2 items-start"><span className="text-[#2ecc71]">•</span> Verify you entered the correct email address</li>
              <li className="flex gap-2 items-start"><span className="text-[#2ecc71]">•</span> Wait a few minutes - emails can take time to arrive</li>
            </ul>
          </motion.div>
